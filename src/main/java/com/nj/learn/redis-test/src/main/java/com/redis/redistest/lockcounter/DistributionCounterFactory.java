package com.redis.redistest.lockcounter;
...
public class DistributionCounterFactory {
    ...
    public DistributionCounterFactory(){}

    public static DistributionCounterDemo getCounter(String type, String key) {
        return getCounter(type, key, 0L);
    }

    public static DistributionCounterDemo getCounter(String type, String key, long initCount) {
        switch (type) {
            case DCOUNTER_JEDIS:
